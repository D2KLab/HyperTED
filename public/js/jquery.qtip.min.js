...
!function (a, b, c) {
    !function (a) {
        ...
        d.extend(w.prototype, {init: function (a) {
            ...
            this.update()
        }}, d.extend(E, z.defaults, {style: {tip: {corner: E, mimic: F, width: 6, height: 6, border: E, offset: 0}}}), S.viewport = function (c, d, e, f, g, h, i) {
        ...
        zb = function () {
            ...
            return a && a.isDefaultPrevented() ? this : (zb.toggle(this.qtip, !!b, c), void 0)
        }, destroy: function () {
        ...
        }}, d.extend(E, z.defaults, {show: {modal: {on: F, effect: E, blur: E, stealfocus: E, escape: E}}});
